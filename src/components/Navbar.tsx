...
function navClass(isActive: boolean) {
  if (isActive) {
    return `${linkBase} bg-neutral-900 text-white shadow-sm dark:bg-white dark:text-neutral-900`
  }
  return `${linkBase} bg-white text-neutral-700 hover:bg-neutral-100 hover:text-neutral-900
    dark:bg-neutral-900 dark:text-neutral-200 dark:hover:bg-neutral-800 dark:hover:text-white`
}
      ...
      <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
        <div className="flex flex-wrap items-center justify-between py-3 gap-3">
          ...
          <nav className="flex flex-wrap items-center gap-2">
            ...
            <button
              onClick={toggleTheme}
              className="ml-1 inline-flex items-center gap-2 rounded-xl border border-neutral-200 bg-white px-3 py-2 text-sm font-semibold text-neutral-800 hover:bg-neutral-50
            ...
            >
              ...
              <span className="hidden sm:inline">
                {lang === "en" ? (theme === "dark" ? "Light" : "Dark") : theme === "dark" ? "Claro" : "Oscuro"}
              </span>
            </button>

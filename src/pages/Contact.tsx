        ...
        <div className="py-10">
          ...
          <div className="mt-6 grid grid-cols-1 gap-4 sm:grid-cols-2">
            <div className="rounded-2xl border border-neutral-200 bg-white p-6 shadow-sm dark:border-neutral-800 dark:bg-neutral-900">
              ...
              <a
                className="mt-2 block text-lg font-semibold text-neutral-900 dark:text-neutral-100"
                href={`mailto:${data.email}`}
              >
                {data.email}
              </a>
              <div className="mt-3 text-sm text-neutral-600 dark:text-neutral-300">{data.phone}</div>
            </div>

            <div className="rounded-2xl border border-neutral-200 bg-white p-6 shadow-sm dark:border-neutral-800 dark:bg-neutral-900">
              <div className="text-sm text-neutral-500 dark:text-neutral-400">{t.links}</div>
              <div className="mt-3 flex flex-col gap-2">
                {data.links.map((l) => (
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className="rounded-xl border border-neutral-300 bg-white px-4 py-2 text-sm font-semibold text-neutral-900 hover:bg-neutral-50 dark:border-neutral-800 dark:bg-neutral-900 dark:text-neutral-100 dark:hover:bg-neutral-800"
                  >
                    {l.label}
                  </a>
                ))}
